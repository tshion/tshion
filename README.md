...
ダイレクト | エージェント経由 | 両方
--- | --- | ---
・Findy: Shion<br />・**Forkwell: @tshion**<br />・**[LAPRAS](https://lapras.com/public/KWNGP2D)**<br />・Offers: shion<br />・PayCareer: (本名)<br />・[TechFeed](https://techfeed.io/people/@shion_engineer)<br />・転職ドラフト(予定) | ・マイナビIT エージェント: (本名)<br />・レバテックキャリア: (本名) | ・ビズリーチ: (本名)
